...
type TcGlobals(
  ...
  let v_choice8_tcr     = mk_MFCore_tcref fslibCcu "Choice`8"
  let v_choice9_tcr     = mk_MFCore_tcref fslibCcu "Choice`9"
  let v_choice10_tcr    = mk_MFCore_tcref fslibCcu "Choice`10"
  let v_choice11_tcr    = mk_MFCore_tcref fslibCcu "Choice`11"
  let v_choice12_tcr    = mk_MFCore_tcref fslibCcu "Choice`12"
  let v_choice13_tcr    = mk_MFCore_tcref fslibCcu "Choice`13"
  let v_choice14_tcr    = mk_MFCore_tcref fslibCcu "Choice`14"
  let v_choice15_tcr    = mk_MFCore_tcref fslibCcu "Choice`15"
  let v_choice16_tcr    = mk_MFCore_tcref fslibCcu "Choice`16"
  let v_choice17_tcr    = mk_MFCore_tcref fslibCcu "Choice`17"
  let v_choice18_tcr    = mk_MFCore_tcref fslibCcu "Choice`18"
  let v_choice19_tcr    = mk_MFCore_tcref fslibCcu "Choice`19"
  let v_choice20_tcr    = mk_MFCore_tcref fslibCcu "Choice`20"
  ...
  member _.choice8_tcr = v_choice8_tcr
  member _.choice9_tcr = v_choice9_tcr
  member _.choice10_tcr = v_choice10_tcr
  member _.choice11_tcr = v_choice11_tcr
  member _.choice12_tcr = v_choice12_tcr
  member _.choice13_tcr = v_choice13_tcr
  member _.choice14_tcr = v_choice14_tcr
  member _.choice15_tcr = v_choice15_tcr
  member _.choice16_tcr = v_choice16_tcr
  member _.choice17_tcr = v_choice17_tcr
  member _.choice18_tcr = v_choice18_tcr
  member _.choice19_tcr = v_choice19_tcr
  member _.choice20_tcr = v_choice20_tcr
